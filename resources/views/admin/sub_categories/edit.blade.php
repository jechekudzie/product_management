                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/sub_categories/'.$subCategory->category->slug.'/index')}}" class="btn btn-info add-btn"><i
                            ...
                            <!--end add modal-->
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        <form method="post" action="{{url('/admin/sub_categories/'.$subCategory->slug)}}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
