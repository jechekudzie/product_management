                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/sub_categories/'.$subCategory->category->slug.'/index')}}" class="btn btn-info"><i
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/products/'.$product->slug.'/edit')}}">Edit <i
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/products/'.$product->slug.'/edit')}}">View </a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered ">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{ url('/admin/products/'.$subCategory->slug.'/store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="number" name="price" step="0.01" class="form-control rounded-pill mb-3" value="{{old('price')}}" placeholder="Enter product price">
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <label for="original_size" class="form-label">Original Size</label>
                                                        <input type="text" name="original_size" class="form-control rounded-pill mb-3" value="{{old('original_size')}}" placeholder="Enter original size">
                                                    </div>
...
@push('scripts')
    ...
    <script>
        function addSizeField() {
            const container = document.getElementById('other_sizes_container');
